...
class Activity {
  ...
  String getDate() {
    ...
    if (date2 != null) {
      ...
      dateStr =
          '${DateFormat.yMMMMEEEEd('fr').format(date2)} à ${DateFormat.Hm('fr').format(date2)}';
    } else {
                  ...
                  return Card(
                    child: ListTile(
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) => DescriptionPage(
                              ...
                              numberOfRemainingEntries: int.parse(
                                  activity.getNumberOfRemainingEntries()),
                      ...
                      leading: CircleAvatar(
                          backgroundImage:
                              NetworkImage(activity.getPictureURL())),
                    ),
                  );
                },
              ),
